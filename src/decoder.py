...
class MultiHeadAttention(nn.Module):
    ...
    def __init__(self, d_model: int, num_attention_heads: int):
        ...
        self.d_k = d_model // num_attention_heads  # Key dimension per head
        self.d_v = d_model // num_attention_heads  # Value dimension per head
        self.d_q = d_model // num_attention_heads  # Query dimension per head
        ...
        # Output projection
        self.output_linear = nn.Linear(num_attention_heads * self.d_v, d_model)
...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, mask: torch.Tensor) -> torch.Tensor:
        ...
        attention_output = self.self_attention(norm_x, mask)
